    ...
    <div className="space-y-3 mb-6">
      ...
      <div className="flex gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 rounded-2xl border border-pink-100 dark:border-gray-600 bg-white dark:bg-gray-800 dark:text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-300 text-sm placeholder:text-gray-400"
          />
        </div>
        <button
      ...
      {abierto && (
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-pink-100 dark:border-gray-700 shadow-md p-6">
          <p className="text-xs font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-3">Categoría</p>
