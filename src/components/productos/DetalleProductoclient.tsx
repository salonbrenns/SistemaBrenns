          ...
          <div className="space-y-3 lg:sticky lg:top-8">
            <div className="relative rounded-3xl overflow-hidden bg-rose-50 dark:bg-gray-800 shadow-xl aspect-square">
              ...
              <button onClick={handleFavorito}
                ...
                className="absolute top-4 right-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md p-2 rounded-full shadow-md hover:bg-rose-600 hover:text-white dark:text-gray-300 transition-all duration-200">
                <Heart
                  size={22}
