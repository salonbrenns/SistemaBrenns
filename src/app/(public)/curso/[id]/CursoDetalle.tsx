...
export default function CursoDetalleClient({ curso, isLoggedIn }: { curso: Curso; isLoggedIn: boolean }) {
  ...
  return (
    <div className="min-h-screen bg-[#fffafa] dark:bg-gray-950 py-12 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        
        {/* Navegación */}
        <div className="mb-10">
          <BackButton fallbackHref="/cursos" label="Volver al catálogo de cursos"
            className="inline-flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm font-medium hover:text-rose-600 dark:hover:text-rose-400 transition-colors group"
          />
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            {/* Galería Principal */}
            <div className="relative aspect-[16/10] rounded-[2.5rem] overflow-hidden shadow-2xl shadow-rose-100 bg-white border border-rose-50 dark:border-gray-700">
              {imagenActiva ? (
                <Image 
                  src={imagenActiva} 
                  alt={curso.titulo} 
              ...
              {curso.nivel && (
                <div className="absolute top-6 left-6">
                  <span className={`px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest border shadow-sm ${nivelColor[nivelKey] || "bg-gray-50 dark:bg-gray-900 text-gray-600 dark:text-gray-400 border-gray-100"}`}>
                    {curso.nivel}
                  </span>
                </div>
              )}
            ...
            {/* Acerca del curso */}
            <div className="bg-white dark:bg-gray-800 rounded-[2rem] p-8 border border-rose-50 dark:border-gray-700 shadow-sm">
          ...
          <div className="lg:col-span-5 sticky top-12">
            <div className="bg-white dark:bg-gray-800 rounded-[2.5rem] p-10 border border-rose-100 shadow-2xl shadow-rose-100/50">
              
              {/* Encabezado */}
              <div className="mb-8">
                <h1 className="text-4xl font-black text-gray-900 dark:text-white leading-tight mb-4 italic">
                  {curso.titulo}
                </h1>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="p-4 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-100">
