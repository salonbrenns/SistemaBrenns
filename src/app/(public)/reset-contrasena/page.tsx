  ...
  if (exito) {
    return (
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-3">¡Contraseña actualizada!</h2>
        <p className="text-gray-500 dark:text-gray-400 mb-8 text-sm">Ya puedes iniciar sesión con tu nueva contraseña.</p>
        <Link href="/login"
  ...
  return (
    <>
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Nueva contraseña</h1>
        
        <p className="text-gray-500 dark:text-gray-400 mt-2 text-sm">Elige una contraseña segura para tu cuenta.</p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:border-pink-400 text-sm bg-white dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
            />
        ...
        <div>
          <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Confirmar contraseña</label>
          <div className="relative">
            <Lock className="absolute left-3 top-3 w-5 h-5 text-gray-400" />
            <input
...
export default function ResetContrasenaPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white dark:from-gray-900 dark:to-gray-900 flex items-center justify-center px-4">
      <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-10 max-w-md w-full">
