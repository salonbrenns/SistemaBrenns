    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white dark:from-gray-900 dark:to-gray-900 flex items-center justify-center px-4">
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-10 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-3">¡Correo enviado!</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white dark:from-gray-900 dark:to-gray-900 flex items-center justify-center px-4">
      <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-10 max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800 dark:text-white">¿Olvidaste tu contraseña?</h1>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:border-pink-400 text-sm bg-white dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
              />
            </div>
          </div>
