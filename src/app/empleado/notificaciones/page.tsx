    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          <div key={label} className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-4 flex items-center gap-4">
                  ...
                  <div key={cita.id} className={`border-l-4 ${grupo.color} bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm`}>
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-2 bg-white dark:bg-gray-800 border border-pink-200 dark:border-pink-800 text-pink-600 rounded-xl hover:bg-pink-50 dark:hover:bg-gray-700 transition text-xs font-semibold whitespace-nowrap shadow-sm">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-6 space-y-4">
            ...
            <div className="flex gap-3">
              <button onClick={() => setCitaSel(null)}
                className="flex-1 border-2 border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 font-bold py-2.5 rounded-full hover:bg-gray-50 dark:hover:bg-gray-700 transition text-sm">
                Cancelar
              </button>
