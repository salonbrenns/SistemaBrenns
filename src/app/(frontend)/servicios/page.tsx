...
import FiltroServicios from '@/components/ui/FiltroServicios'   // ← Nuevo componente
...
export default function ServiciosPage() {
  ...
  const serviciosFiltrados = serviciosData
    ...
    .filter(s => 
      ...
      categoriasSeleccionadas.includes(s.categoria)
    )

  return (
    <main className="min-h-screen bg-[#fffafa]">
      
      {/* Barra de Filtros - Ahora arriba y fija */}
      <FiltroServicios
        busqueda={busqueda}
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-12">
        ...
        {cargando && (
          <div className="flex flex-col justify-center items-center py-40">
            ...
            <p className="text-pink-600 font-medium animate-pulse mt-4">
