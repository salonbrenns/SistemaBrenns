...
function ConfirmacionContenido() {
  ...
  return (
    <div className="min-h-screen bg-[#fffafa] dark:bg-gray-950 py-16">
      <div className="max-w-2xl mx-auto px-6 space-y-8">
        ...
        {/* Número de pedido */}
        <div className="bg-white dark:bg-gray-800 rounded-3xl border border-rose-100 shadow-sm p-6 text-center">
        ...
        {/* Método de pago */}
        <div className="bg-white dark:bg-gray-800 rounded-3xl border border-rose-100 shadow-sm p-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl border border-rose-100 shadow-sm p-6">
          ...
          <div className="pt-4 mt-4 border-t border-gray-100 space-y-1.5 text-sm">
            ...
            <div className="flex justify-between font-black text-gray-900 dark:text-white text-base pt-1 border-t border-gray-100">
              <span>Total</span>
