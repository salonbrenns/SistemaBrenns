      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        {items.length > 0 ? (
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              {items.map(item => {
                ...
                return (
                  <div key={item.id} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-rose-50 dark:border-gray-700 overflow-hidden">
                    <div className="p-5 flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          <div>
                            <Link
                              ...
                              className="font-bold text-gray-900 dark:text-white hover:text-rose-600 transition-colors line-clamp-1">
                        ...
                        <div className="flex items-center justify-between mt-3">
                          {/* Selector cantidad */}
                          <div className="flex items-center bg-gray-50 dark:bg-gray-900 rounded-full border border-gray-200 dark:border-gray-700">
                            <button
                            ...
                            <button
                              ...
                              className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition disabled:opacity-40">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8 border border-rose-100 sticky top-6 space-y-4">
                <h2 className="text-xl font-black text-gray-900 dark:text-white">Resumen del pedido</h2>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Subtotal ({totalItems} art.)</span>
                ...
                <Link href="/checkout">
                  <button className="w-full mt-2 bg-gray-900 dark:bg-gray-700 hover:bg-rose-700 text-white font-black py-4 rounded-2xl transition-all shadow-lg active:scale-95 text-base uppercase tracking-wide">
                    Proceder al pago
                  </button>
                </Link>
          ...
          <div className="text-center py-32 bg-white dark:bg-gray-800 rounded-[3rem] shadow-inner border-2 border-dashed border-rose-100">
            ...
            <p className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Tu carrito está vacío</p>
            <p className="text-gray-500 dark:text-gray-400 mb-8">Explora el catálogo y agrega productos</p>
            <Link href="/catalogo">
