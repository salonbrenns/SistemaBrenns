  ...
  <button
    ...
    className={`w-full text-left rounded-2xl border-2 p-5 cursor-pointer transition-all focus:outline-none focus:ring-2 focus:ring-pink-400 ${
      m.leido
        ...
        : "border-pink-200 dark:border-pink-800 bg-pink-50 dark:bg-pink-950/20 shadow-sm"
    }`}
  >
              {/* Estado */}
              ...
              {/* Mensaje */}
              <p className={`text-sm font-medium mb-4 ${m.leido ? "text-gray-600 dark:text-gray-400" : "text-gray-800 dark:text-white"}`}>
                {m.mensaje}
              </p>

              {/* Info de la cita */}
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 px-4 py-3 flex flex-wrap gap-4 text-xs text-gray-500 dark:text-gray-400">
