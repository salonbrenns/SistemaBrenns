          ...
          <>
            {favoritos.length === 0 && (
              <div className="text-center py-32 bg-white dark:bg-gray-800 rounded-[3rem] shadow-inner border-2 border-dashed border-rose-100">
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-8">Guarda los productos que más te gusten</p>
                <Link href="/catalogo">
                    ...
                    <article key={fav.id} className="group bg-white dark:bg-gray-800 rounded-[2rem] shadow-sm hover:shadow-xl border border-rose-50 dark:border-gray-700 overflow-hidden transition-all duration-300 hover:-translate-y-1">
                      <Link href={`/producto/${p.id}`} className="block">
                        <div className="relative h-56 overflow-hidden bg-rose-50">
                          ...
                          {!p.en_stock && (
                            <div className="absolute inset-0 bg-black/25 flex items-center justify-center">
                              <span className="bg-white text-gray-700 dark:text-gray-300 text-xs font-black px-3 py-1.5 rounded-full uppercase tracking-widest">Agotado</span>
                            </div>
                          )}
                          <button
                        ...
                        <div className="p-5">
                          ...
                          <h3 className="font-bold text-gray-900 dark:text-white line-clamp-2 leading-snug group-hover:text-rose-600 transition-colors mb-2">
                            {p.nombre}
                          </h3>
          ...
          <>
            {favServicios.length === 0 && (
              <div className="text-center py-32 bg-white dark:bg-gray-800 rounded-[3rem] shadow-inner border-2 border-dashed border-rose-100">
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-8">Guarda los servicios que más te interesen</p>
                <Link href="/servicios">
                  <button className="px-8 py-3 bg-rose-700 text-white font-bold rounded-full hover:bg-rose-800 transition shadow-xl">
                    Explorar servicios
                  </button>
