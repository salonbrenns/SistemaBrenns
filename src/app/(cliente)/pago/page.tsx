        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-6 md:p-8">
                <div className="flex gap-3 mb-8">
                  <div className="px-5 py-2 rounded-full bg-gray-100 text-gray-500 dark:text-gray-400 text-xs font-bold">1. Fecha y Hora</div>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="bg-pink-50/50 dark:bg-gray-800/50 p-6 rounded-3xl border border-pink-100 space-y-4">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-6 sticky top-4 border border-pink-100">
