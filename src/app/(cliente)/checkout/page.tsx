...
const METODOS = [
  {
    ...
    icon:  Building2,
    desc:  'Deposita o transfiere y envía tu comprobante',
  },
  {
    id:    'efectivo',
    ...
    return (
      <div className="min-h-screen bg-[#fffafa] dark:bg-gray-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl font-bold text-gray-700 dark:text-gray-300 mb-6">Tu carrito está vacío</p>
          <Link href="/catalogo">
    ...
    <div className="min-h-screen bg-[#fffafa] dark:bg-gray-950 py-12">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-400 mb-8">
          ...
          <span className="text-gray-700 dark:text-gray-300 font-semibold">Finalizar compra</span>
        </nav>

        <h1 className="text-3xl font-black text-gray-900 dark:text-white mb-10">Finalizar Compra</h1>
        ...
        <form onSubmit={handleSubmitManual}>
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* Datos de contacto */}
              <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-rose-50 dark:border-gray-700 p-8">
                <h2 className="text-lg font-black text-gray-900 dark:text-white mb-6">Datos de contacto</h2>
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label htmlFor="nombre" className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Nombre *</label>
                    <input
                      id="nombre"
                      value={form.nombre}
                  ...
                  <div className="space-y-1">
                    <label htmlFor="apellido" className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Apellido</label>
                    <input
                      id="apellido"
                      value={form.apellido}
                  ...
                  <div className="space-y-1">
                    <label htmlFor="correo" className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Correo *</label>
                    <input
                      id="correo"
                      type="email"
                      value={form.correo}
                  ...
                  <div className="space-y-1">
                    <label htmlFor="telefono" className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Teléfono</label>
                    <input
                      id="telefono"
                      value={form.telefono}
              ...
              {/* Método de pago */}
              <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-rose-50 dark:border-gray-700 p-8">
                <h2 className="text-lg font-black text-gray-900 dark:text-white mb-6">Método de pago</h2>
                    ...
                    return (
                      <label key={m.id}
                        className={`flex items-center gap-4 p-4 rounded-2xl border-2 cursor-pointer transition-all ${
                          activo ? 'border-rose-500 bg-rose-50' : 'border-gray-200 dark:border-gray-700 hover:border-rose-300'
                        }`}>
                ...
                {metodoPago === 'efectivo' && (
                  <div className="mt-6 p-4 rounded-2xl bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800">
                    <p className="text-xs font-bold text-green-700 dark:text-green-400 mb-1">Pago en sucursal</p>
                    <p className="text-xs text-green-600 dark:text-green-400">Presenta tu número de pedido al recoger. Tienes 48 horas para pagar.</p>
                  </div>
                )}
              </div>

              {error && (
                <div className="p-4 rounded-2xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 text-sm font-semibold">
                  {error}
                </div>
              )}
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-rose-50 dark:border-gray-700 p-6 sticky top-6 space-y-4">
                    ...
                    return (
                      <div key={item.id} className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-bold text-gray-800 dark:text-gray-100 line-clamp-1">{item.producto.nombre}</p>
                          {atributos && <p className="text-[10px] text-rose-500 font-semibold">{atributos}</p>}
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">x{item.cantidad}</p>
                        </div>
                        <p className="text-xs font-black text-gray-900 dark:text-white whitespace-nowrap">
