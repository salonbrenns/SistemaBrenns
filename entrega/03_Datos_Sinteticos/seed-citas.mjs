...
const NUM_CITAS_PASADAS = 2000;  // ya "resueltas": CONFIRMADA o CANCELADA (>= 2,000 registros útiles para el modelo)
  ...
  for (let i = 0; i < citas.length; i += BATCH) {
    ...
    await prisma.$queryRawUnsafe(`
      INSERT INTO agenda.tblcitas
        (usuario_id, servicio_id, empleado_id, fecha, hora, created_at,
